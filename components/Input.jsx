...
const Input = ({ inputType, title, placeholder, handleClick, classStyles }) => {
  ...
  return (
    <div className="mt-10 w-full">
      ...
      {inputType === 'number' ? (
        ...
        <input
          className={`dark:bg-nft-black-1 bg-white border dark:border-nft-black-1 border-nft-gray-2 rounded-lg   w-full outline-none font-poppins dark:text-white text-nft-gray-2 text-base mt-4 px-4 py-3 ${classStyles}`}
          placeholder={placeholder}
          onChange={handleClick}
        />
      )}
